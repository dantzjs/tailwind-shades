...
test('Shade [600] for #800 must be #6d0000', () => {
    expect(shadesOf('#800')[600]).toBe('#6d0000')
})
...
test('Shade [600] for #800 and format rgb must be 109 0 0', () => {
    expect(shadesOf('#800', { format: 'rgb'})[600]).toBe('109 0 0')
})
